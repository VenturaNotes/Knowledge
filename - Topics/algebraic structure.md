...
- 
## Source [^1]
- An alternative expression for an algebra. Sometimes there is a technical difference: algebras are always sets with constants and functions; algebraic structures are sometimes algebras to which are added relations. A common term for this latter case is [[algebraic system]] (or model).
