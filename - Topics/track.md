...
## Source[^2]
- (1) The portion of a moving storage medium, such as magnetic tape or disk, that is accessible to a given reading device in a computer. 
- (2) An interconnecting metal path on an integrated circuit.
## References
