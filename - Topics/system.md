...
## Source[^2]
- An assembly of components or elements connected together in an organized way to produce outputs; the components of the assembly are affected by being in the system and the behavior of the system is changed if any component leaves it.
## Source[^3]
