...
- 
## Source [^1]
- (symbol: n) A prefix to a unit, indicating a submultiple of one billionth, $10^{-9}$, of that unit, as in nanosecond.
## Source[^2]
...
## Source[^5]
- Prefix used with SI units to denote multiplication by $10^{-9}$. Abbreviated as n.
## References
