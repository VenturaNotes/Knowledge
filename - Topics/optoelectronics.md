...
## Source[^2]
- The study and design of electronic devices that manipulate light in some way. These range from photodetectors that convert light into electricity to semiconductor lasers and light-emitting diodes. The underlying theory is largely based on the principles of quantum physics. See also OPTICAL ELECTRONICS.
## References
