...
## Source[^3]
- $n$. The unit of hereditary transmission encoded in DNA, occupying a fixed locus on a chromosome and transmitted from a parent to its offspring, consisting of a sequence of base (1) pairs corresponding to a specific sequence of amino acids making up a protein, functioning either to build body cells (if it is a structural gene) or else to regulate the expression of other genes (if it is a regulator gene). The human genome, present in every somatic cell, contains approximately 21,000 to 23,000 genes encoded in about 3 billion base pairs. See also CISTRON, CODON, GENE ACTIVATOR, GENE LOCUS, GENE MAPPING, GENE OPERATOR, GENE REPRESSOR, GENE SPLICING, OPERON, SUPERGENE. genetic adj. Of or pertaining to genes. \[The word was introduced in 1909 by the Danish plant physiologist and geneticist Wilhelm Johannsen (1857-1927) in a book entitled Elemente der exakten Erblichkeitslehre (Elements of Exact Heredity), from German Gen a gene, from Greek genes born]
## References
