...
## Source[^6]
- A short-range radio communications system, intended to connect devices, for example mobile phones, PDAs, and keyboards, within a few meters of each other. It uses frequency-hopping spread spectrum and operates in the 2.4 GHz ISM band.
## References
