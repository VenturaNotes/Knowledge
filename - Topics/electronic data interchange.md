...
- 
## Source [^1]
- A family of standards that describe the format, content, and structure of data to be exchanged between computer systems. Such data are not intended for human interpretation but for treatment by a computer. The term is generally used to describe standards at the application level of the OSI seven-layer reference model.
## Source[^2]
