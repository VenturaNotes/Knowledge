...
## Source[^4]
- $n$. The diffusion of a solvent such as water across a semipermeable membrane from the side where the solution is less concentrated to the side where it is more concentrated until the concentration and the osmotic pressure on both sides is equalized. See also cell membrane. Compare dialysis. osmotic adj. \[From Greek osmos thrust or impulse + -osis indicating a process or state]
## References
