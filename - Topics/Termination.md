...
## Source [^1]
### Loop Invariant
- Loop terminates (along with reason) which gives us a useful property that helps show the algorithm is correct
...
## Source[^3]
- A load impedance connected across the output of a transmission line or transducer that completes the circuit while ensuring impedance matching and preventing unwanted reflections.
## References
