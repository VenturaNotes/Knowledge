...
y^{\prime \prime}=f\left(x, y, y^{\prime}\right), a \leq x \leq b
...
P(x)=\sum_{i=1}^{p} \alpha_{i} \phi_{i}(x)

$$

  

can be obtained from a suitable set of orthogonal functions $\phi_{i}(x)$ by choosing the coefficients $\alpha_{i}$ for which

  

$$

P^{\prime \prime}\left(x_{i}\right)=f\left(x_{i}, P\left(x_{i}\right), P^{\prime}\left(x_{i}\right)\right)
...
a \leq x_{1}<x_{2}<\ldots<x_{n} \leq b
