...
---
## Synthesis
- They are powerful tools for pattern matching and manipulation of strings. 
	- #question What are some ways of doing this in python?
- They allow you to define a search pattern using a special syntax, which can then be used to find, replace, or split text based on that pattern.
	- #question How does the special syntax work?
	- #question How do you find using regex?
	- #question How do you replace using regex?
- At its core, a regular expression is a sequence of characters that defines a search pattern.
	- #question What does the sequence of characters look like?
## Source [^1]
