...
- Basic structural units in all sentences
	- Subjects
	- Predicates
- Larger classes of structures
	- Modifiers
	- Phrases
	- Clauses
## Source[^2]
...
## Source[^3]
- Syntax refers to the rules that govern the structure of a language. In programming terms, it's essential to understand syntax to write code that is both accurate and easy to read.
## Source[^4]
- The instruction to a computer that it must obey certain rules, usually referred to as the language's syntax. Syntax error is stated by the machine when instruction errors have been made by the programmer, usually at compile time.
## References
