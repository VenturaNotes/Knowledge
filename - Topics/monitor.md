...
- 
## Source [^1]
- Traditional monitors and keyboards use the [[simplex transmission mode]]. The monitor can only generate the output, and the keyboard can only introduce an input in the system.
