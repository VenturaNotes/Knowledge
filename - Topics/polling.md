...
## Source[^2]
- Sequential interrogation of a number of difference sources of data in a digital system, each data source having its own line or digital address. The information gathering part of the circuit will interrogate each source to see if it has data it wishes to send.
## References
