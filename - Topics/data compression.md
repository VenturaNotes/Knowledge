...
## Source[^2]
- The process of reducing the amount of data that represents a signal with minimum degradation to the signal when it is reconstructed. This may be of interest in order to reduce transmission bandwidth or storage requirements. One example is speech data compression using linear predictive coding (see LINEAR PREDICTION).
## References
