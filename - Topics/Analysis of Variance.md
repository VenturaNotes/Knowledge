...
- (2) In standard costing and budgetary control, the analysis of variances in order to seek their causes. The total profit variance or production cost variance is analysed into sub-variances, based on such factors as direct labor, direct materials, fixed and variable overheads, and sales, in order to indicate the major reasons for the difference between budgeted figures and actual figures.
## Source[^5]
