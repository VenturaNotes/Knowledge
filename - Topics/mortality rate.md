...
- 
## Source [^1]
- (death rate) The crude death rate, i.e. the number of deaths per 1,000 of the average population in a given year. It can be subdivided into different rates for different age groups of the population and for different regions.
## Source[^2]
