...
## Source [^1]
- $n$. 
- (1) (in anatomy) a threadlike structure, such as a muscle cell, a nerve fiber, or a collagen fiber. 
- (2) (in dietetics) see DIETARY FIBER. -fibrous adj.
## Source[^2]
- (1) An elongated plant cell whose walls are extensively (usually completely) thickened with lignin (see sclerenchyma). Fibers are found in the vascular tissue, usually in the xylem, where they provide structural support. The term is often used loosely to mean any kind of xylem element. The fibres of many species, e.g. flax, are of commercial importance. 
