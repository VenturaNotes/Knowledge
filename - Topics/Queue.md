...
## Source[^2]
- A number of customers for a good or service waiting to be served. Queue discipline describes the order in which customers are served: this may be first-come first-served, random order, or last-in first-out, or some system of priorities may be used. Queuing models analyse the behavior of queues, often using numerical simulation, and explore efficient ways of handling queues.
## References
