...
## Source[^3]
- The scale of the neighborhood of a point that is utilized in the non-parametric estimation of a function at that point. For example, if a histogram is used as a non-parametric estimator of the probability density function, the bandwidth is the size of the bin (the range of values in each category). See also KERNEL REGRESSION.
## Source[^4]
