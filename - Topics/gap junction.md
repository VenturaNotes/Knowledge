...
## Source[^2]
- $n$. A rare type of synapse in which a signal is transmitted from one neuron to another by electrical induction across a very narrow gap between them without the involvement of any chemical neurotransmitter. Also called an electrical synapse.
## References
