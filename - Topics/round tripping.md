...
- 
## Source [^1]
- (1) Any of various practices in which a company, A, sells an asset to a buyer, B (who is often in another jurisdiction) and then purchases an equivalent asset from $B$ at essentially the same price. The selfcancelling nature of the transaction is usually disguised by passing the assets through a chain of intermediaries. The object may be money laundering, tax evasion, or a desire to inflate the company's trading figures. 
