...
## Source[^2]
- $n$. In statistics, any discrete variable that has a limited number of distinct values, such as gender$\textemdash$which has two values, namely male and female. Compare CONTINUOUS VARIABLE.
## References
