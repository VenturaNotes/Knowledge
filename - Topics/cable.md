...
## Source[^2]
- An assembly of conductors that has some degree of flexibility; the conductors are insulated from each other and enclosed in a common binding or sheath. The most common types of cable are paired cable and coaxial cable although other configurations may be used. A composite cable is one in which the gauge of the conductors and/or the type of construction is not the same throughout its cross section.
## References
