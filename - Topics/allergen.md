...
- 
## Source [^1]
- $n$. Any substance, usually a foreign protein, that functions as an antigen and causes an allergic reaction. See allergy. \[From Greek allos other + ergon activity or work]
## Source[^2]
...
## Source[^3]
- An antigen that provokes an abnormal immune response. Common allergens include pollen and dust (see ALLERGY).
## References
