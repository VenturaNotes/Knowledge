...
- 
## Source [^1]
- An image file format developed by a set of companies chaired by Aldus. The specification is now controlled by Adobe Systems Inc. It is widely used in the desktop publishing industry for representing color or grey-scale pictures.
## Source[^2]
