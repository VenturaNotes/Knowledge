...
- 
## Source [^1]
- An instruction specifying that the contents of a shiftable register (occasionally concatenated registers) are to be shifted either to the left or to the right a specified number of register positions.
