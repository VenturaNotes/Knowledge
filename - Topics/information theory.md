...
## Source[^4]
- An analytical technique that determines the optimum amount of information required (i.e. the necessary and sufficient amount) to transmit a message or solve a specific problem in communication, control, or computer systems. The information content of a message is the minimum amount of information required to transmit the message with a desired accuracy, in the absence of noise. Information retrieval is the means of extracting specific information from stored or transmitted data.
## References
