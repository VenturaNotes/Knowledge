...
## Source[^3]
- A printed circuit board (PCB) that holds and supports all the other PCBs in a computer. These PCBs, known as daughter boards, may include one to control access to the disk drives, one to provide high-resolution graphics, and one to support the input/output user ports.
## References
