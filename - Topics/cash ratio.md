...
## Source[^2]
- (liquidity ratio) The ratio of the cash reserve that a bank keeps in coin, banknotes, etc., to its total liabilities to its customers, i.e. the amount deposited with it in current accounts and deposit accounts. Because cash reserves earn no interest, bankers try to keep them to a minimum, consistent with legal reserve requirements.
## References
