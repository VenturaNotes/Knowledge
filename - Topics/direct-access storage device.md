...
- 
## Source [^1]
- One of a class of storage devices in which physical records are addressable and can therefore be accessed in any order: a sequential search is not required. For all practical purposes direct-access storage is synonymous with disk storage.
## Source[^2]
