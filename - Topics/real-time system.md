...
## Source[^2]
- A system where correct operation is dependent on the output values and the time at which they appear. The term is often applied to control systems, where the controlling outputs must be sent at regular intervals in order to have correct system operation.
## References
