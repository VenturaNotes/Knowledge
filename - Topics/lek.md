...
- 
## Source [^1]
- (ALL) The standard monetary unit of Albania, divided into 100 qindars.
## Source[^2]
...
## Source[^3]
- $n$. A small area of ground where certain species of birds such as grouse gather for courtship (1) and display (1), or the behavior that occurs at such a location, or the season during which such behavior takes place. \[From Old English lacan to frolic, perhaps from Swedish leka to play]
## References
