## Synthesis
- The amount of time it takes for data to travel from one point to another across a network, essentially measuring the delay in communication between two devices
	- A network with high latency experiences noticeable [[lag]]
	- A low latency network provide fast response times
## Source[^1]
- (1) A measure of how long it takes for a given job or piece of work to be completed, or for a message to make its way from source to destination. See also THROUGHPUT. 
