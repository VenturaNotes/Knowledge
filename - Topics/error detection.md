...
## Source[^2]
- Detection of errors in data transmitted over a communication line or handled by a computer device. Error-detecting codes encode data in such a way that a decoder can detect, with high probability of success, whether an intervening channel has caused any error in the signal. See also DIGITAL CODES; DIGITAL COMMUNICATIONS.
## References
