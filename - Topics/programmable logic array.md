...
## Source[^2]
- (programmable logic array) A logic circuit that is a sum-of-products device - input devices AND gates, output devices OR gates - where the input variables to the AND gates are programmable (as in PAL devices), and the inputs to the OR gates are also programmable (see diagram). Crosses in the diagram indicate connections of input variables (A, B, C) to inputs of AND and OR gates.
- ![[Pasted image 20260405230715.png|300]]
	- Generalized PLA
	- Parts
		- Programmable links
		- OUT1
