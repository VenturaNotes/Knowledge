...
## Source[^2]
- An output device used with computers and data-processing systems that prints an entire line of characters at a time. Typical operating speeds range from 200 to 3000 lines per minute.
## References
