...
- 
## Source [^1]
- The area of front panel, desk, or floor space occupied by a device.
## Source[^2]
...
## Source[^3]
- The physical space occupied by a commercial organization. A retailer, for example, with many stores may wish to shrink its footprint if profits are falling, by selling off some of its premises.
## References
