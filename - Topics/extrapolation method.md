...
- 
## Source [^1]
- A numerical method for the solution of a problem based on repeated extrapolation, to produce increasingly more accurate results, from a sequence of basic approximations utilizing different values of a parameter, such as the stepsize (see FINITE-DIFFERENCE METHOD).
