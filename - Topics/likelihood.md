...
- 
## Source [^1]
- The probability that an observation belongs to a probability distribution with parameters $\theta$, considered as a function of the parameters rather than of the observation.
