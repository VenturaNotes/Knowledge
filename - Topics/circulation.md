...
- 
## Source [^1]
- (1) The distribution of a publication. 
- (2) The number of copies sold per issue of a publication.
## Source[^2]
...
## Source[^3]
- For a fluid with velocity field $\mathbf{u}$, the circulation around a closed curve $C$ equals $\Gamma = \int_C \mathbf{u} \cdot d\mathbf{r}$. If $C$ bounds a surface $\Sigma$, then by Stokes’ Theorem $\Gamma = \int_\Sigma \boldsymbol{\omega} \cdot d\mathbf{S}$ where $\boldsymbol{\omega}$ denotes vorticity. Thus, vorticity can be considered (locally) as circulation per unit area.
## References
