...
- 
## Source[^1]
- It is a decision problem in [[computability theory]]
...
## Source[^3]
- An undecidable problem of computability. As there are denumerably many programs (or computable functions), such programs can be counted and assigned a Gödel number. The halting problem asks whether the $i$th program terminates when run with the $i$th input, but no algorithm can decide this.
## References

[^1]: https://brilliant.org/wiki/halting-problem/
