...
## Source[^4]
- A symbol used in writing numbers in their decimal representation or to some other base. In decimal, the digits used are 0–9. In hexadecimal, the digits are 0–9 and A–F. In binary the digits are 0 and 1.
## References
