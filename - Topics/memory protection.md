...
- 
## Source [^1]
- Any of many methods for controlling access to or use of memory. This control may be to prevent inadvertent user interference, to provide for system security, or both.
