...
- 
## Source [^1]
- The interest rate at which future receipts or payments are discounted to find their present value. If the discount rate is $100 r$ per cent per annum, the present discounted value of a payment of $A$ due in $T$ years' time is $V=A /(1+r)^{T}$. See also TEST DISCOUNT RATE.
## Source[^2]
...
- (2) See BILL RATE. 
- (3) The interest rate charged by the US Federal Reserve Banks when lending to other banks.
## References
