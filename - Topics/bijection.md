...
i.e. there is a one-to-one correspondence between the elements in $X$ and the elements in $Y$. The sets $X$ and $Y$ will have the same number of elements, i.e. the same cardinality. There will be a unique function
