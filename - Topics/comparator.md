...
## Source[^2]
- A circuit, such as a differential amplifier, that compares two inputs and produces an output that is a function of the result of the comparison.
## References
