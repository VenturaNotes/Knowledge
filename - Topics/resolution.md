...
## Source[^2]
- A binding decision made by the members of a company. If a motion is put before the members of a company at a general meeting and the required majority vote in favor of it, the motion is passed and becomes a resolution. A resolution may also be passed by unanimous informal consent of the members.
- UK company law recognizes several different types of resolution, each of which has different requirements in terms of the required voting majority. The type of resolution required to make a particular decision may be prescribed by the Companies Act or by the company's articles. For example, an ordinary resolution is required to remove a director and a special resolution is required to change the company's articles of association. See also WRITTEN RESOLUTION.
## Source[^3]
- $n$. 
...
## Source[^5]
- (resolve) The process of writing a vector in terms of its components in two or three mutually perpendicular directions.
## References
