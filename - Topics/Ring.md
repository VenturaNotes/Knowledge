...
- 
## Source [^1]
- (1) An algebraic structure $R$ on which there are defined two dyadic operations, normally denoted by + (addition) and $\cdot$ or juxtaposition (multiplication). With respect to addition, $R$ is an abelian group,$$\langle R,+\rangle$$i.e. + is commutative and associative. With respect to multiplication, $R$ is a semigroup, $$\langle R, \bullet\rangle$$i.e. $\large\cdot$ is associative. Further, multiplication is distributive over addition.
