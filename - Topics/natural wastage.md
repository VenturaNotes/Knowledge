...
- 
## Source [^1]
- The method by which an organization can contract without making people redundant, relying on resignations, retirements, or deaths. If the time is available, this method of reducing a workforce causes the least tension. See also REDUNDANCY.
## Source[^2]
