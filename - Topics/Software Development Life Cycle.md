...
- The full SDLC usually includes these phases:
	...
	- Design – Create system architecture, database models, and UI/UX designs.
		- #question What would design look like? What is system architecture? What are database models? What does UI and UX stand for?
	- Implementation (Coding) – Developers write the actual code.
	- Testing – Conduct unit, integration, system, and acceptance testing.
		- #question Give me in detail what these 
