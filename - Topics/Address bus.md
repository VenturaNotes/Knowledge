...
## Source[^3]
- A special-purpose computer bus that carries only address information. The size of the address bus will specify the memory space that is addressable: $n$ address lines will allow $2^n$ memory locations to be individually identified.
## References
