...
- 
## Source [^1]
- An abstract set of possible values that an instance of the data type may assume, given either implicitly, e.g. INTEGER, REAL, STRING, or explicitly as, for example, in Pascal:$$\text{TYPE color $=$ (red, green, orange)}$$The data type indicates a class of internal representations for those values.
