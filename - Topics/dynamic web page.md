...
- 
## Source [^1]
- (1) A web page whose content or presentation can vary each time it is sent to a client. Such web pages are created by server-side scripting using such technologies as Active Server Pages or JavaServer Pages. 
