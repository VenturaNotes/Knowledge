...
- In general, a recurrence can be considered as an equation connecting the values of the function at a number of related points. It has the form$$\begin{aligned}
