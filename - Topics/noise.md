...
## Source[^4]
- $n$. 
- (1) Any unwanted or disturbing sound, or any sound without any definite frequency or pitch. See also noise (2). Compare tone (1). 
- (2) Random disturbances in any communication channel in addition to the signal that is being transmitted, or more generally any random component in a time series that degrades its periodicity. See COLORED NOISE, FROZEN NOISE, PINK NOISE, WHITE NOISE. See also DECIBEL, SIGNAL DETECTION THEORY, SIGNAL-TO-NOISE RATIO. \[From Latin nausea the sensation of being about to vomit]
## Source[^5]
