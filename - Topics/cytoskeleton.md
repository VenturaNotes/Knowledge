...
## Source[^2]
- $n$. The network of fibrous proteins that provides the framework for the shape of a neuron or other cell, containing mictrotubules that act as transport routes for molecules within the cell and a poorly understood control mechanism analogous to the nervous system of an organism, in some circumstances enabling the cell to make purposeful movements. See also mitosis, PARAMECIUM.
## References
