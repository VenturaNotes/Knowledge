...
## Source[^9]
- ASCII (American standard code for information interchange) A 7-bit code that provides different binary values for the 128 (2⁷) characters and control codes. For example, the character ‘A’ is represented by $100~0001_2$ in ASCII, and 'a' is represented by $110~0001_2$.
- http://ee.hawaii.edu/~tep/EE160/Book/chap4/subsection2.1.1.1.html
	- The ASCII character set
	- #comment This website does not give me permission to access its resource.
## References
