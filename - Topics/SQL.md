...
## Source[^4]
- (Formerly known as SEQUEL, acronym for Structured English

  

Query Language) The de facto standard languagefor database access and update for relational database management systems. See feature SQL.
...
'summaryIllinois.' Alternatively, insert queries can add one row of arbitrary values to a table:
