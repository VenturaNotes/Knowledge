...
## Source[^2]
- (1) In econometrics the kernel is a function that assigns weights to the points in the neighborhood of a given point for the calculation of some weighted average quantity. See also KERNEL REGRESSION.
