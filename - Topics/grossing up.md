...
- 
## Source [^1]
- Converting a net return into the equivalent gross amount. For example, if a net dividend $(d)$ has been paid after deduction of $r \%$ tax, the gross equivalent $(g)$ is given by: $$g=100 d /(100-r)$$
## Source[^2]
