...
- 
## Source [^1]
- (1) (in economic theory) In an overlapping generations model, the relationship between the capital-labour ratio, $k$, and the population growth rate, $n$, that maximizes consumption per capita: $f^{\prime}(k)=n$, where $f$ denotes output per unit of labour as a function of the capital-labour ratio, and hence $f^{\prime}(k)$ is the marginal product of capital. In a competitive economy it equals the interest rate, $r$, so that an alternative formulation of the golden rule is $r=n$.
