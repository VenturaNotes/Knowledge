...
## Source[^4]
- (greatest integer function) The largest integer $\lfloor x \rfloor$ not greater than a given real number $x$. So $\lfloor 3.2 \rfloor = 3$ and $\lfloor 5 \rfloor = 5$. Compare CEILING.
## References
