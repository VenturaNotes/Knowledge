...
## Source[^2]
- A computer bus that is used to transfer data. Each signal line of the bus can transfer one bit. The width of the data bus (the total number of lines) usually determines the word length of the processor, as with 16-bit, 32-bit, 64-bit processors.
## References
