...
## Source[^2]
- (universal serial bus) An external peripheral interface standard for communication between a computer and external peripherals over low-cost cable using serial transmission. USB is replacing existing serial ports and parallel ports and is used with keyboards, mice, printers, scanners, and removable hard drives. It is now available on virtually all personal computers and many printers, scanners, etc. It is supported by all the popular operating systems providing plug-and-play.
