...
## Source[^2]
- Any device that holds information by a physical or chemical method. The term is particularly applied to a memory in a computer, which holds information usually in binary form.
## References
