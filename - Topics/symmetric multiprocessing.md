...
- 
## Source [^1]
- A form of supercomputing based on RISC technology. Compared with traditional supercomputers, SMP systems are relatively easy to program, inexpensive, and can be used for a greater range of applications. They are scalable systems.
## Source[^2]
