...
- (3) A technique used in software for manipulating graphic images. An area of the image may be defined by a mark based on colour, brightness, or some other parameter. The mask can then be used to allow separation of parts of the image.
## References
