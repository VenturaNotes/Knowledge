...
- 
## Source [^1]
- (1) A recording on a CD (CD-R or CD-RW) that is made at one particular time. Generally, multisession recording is possible; i.e. files can be copied in one session and then, more files copied in a later session, etc. 
