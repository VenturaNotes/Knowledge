...
- 
## Source [^1]
- A theorem concerning the existence and nature of fixed points used to give solutions to equations. A fixed point of a function $f$
...
is an element $x$ such that $f(x)=x$. A least fixed point is one that, among all the fixed points of $f$, is lowest in some partial ordering that has been imposed on the elements of $X$. Specifically, if $\leq$ is a partial ordering of $X$ then $x$ is a least fixed point if for fixed point $y$ we have $x \leq y$.
