...
- 
## Source [^1]
- The period of time during which binary data must be present or 'set up' at the input to a digital device before the device enters or samples the data. It is commonly specified for memory devices.
## Source[^2]
