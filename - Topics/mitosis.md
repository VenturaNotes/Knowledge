## Synthesis
- Of the 3 major [[cell]] types, this process of cell division occurs in [[eukaryotic cells]] and [[Archaeal Cells]]
## Source[^1]
...
## Source[^2]
- $n$. a type of cell division in which a single cell produces two genetically identical daughter cells. It is the way in which new body cells are produced for both growth and repair. Division of the nucleus (karyokinesis) takes place in four stages (see PROPHASE; METAPHASE; ANAPHASE; TELOPHASE) and is followed by division of the cytoplasm (cytokinesis) to form the two daughter cells (see illustration overleaf). Compare MEIOSIS. $\textendash$mitotic adj.
- ![[Screenshot 2025-08-25 at 4.03.44 AM.png|400]]
	- Stages in mitosis
	- Parts
		- Prophase
			- Cytoplasm
		...
		- Metaphase
			- Centriole
			- Spindle
			- Chromosomes attached to equatorial region
		- Early anaphase
			- chromatids separate
		- Anaphase
...
- ![[Screenshot 2025-09-11 at 6.32.36 PM.png|400]]
	...
	- #comment Parts written out in biology oxford reference
## References

[^1]: https://medlineplus.gov/genetics/understanding/howgeneswork/cellsdivide/#:~:text=During%20mitosis%2C%20a%20cell%20duplicates,such%20as%20cancer%20can%20result.
