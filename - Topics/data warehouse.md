...
- 
## Source [^1]
- A database system that is designed to support data archiving and subsequent analysis and reporting. It contains both current and historical data but does not support the transaction processing that is required for a database handling currently ongoing business interactions.
