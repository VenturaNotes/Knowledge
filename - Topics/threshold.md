...
## Source[^2]
- (in physiology) The minimum intensity of a stimulus that is necessary to initiate a response.
## Source[^3]
- The value at which a change in system state will occur. The term is usually applied to logic devices, and specifies the value of the inputs at which the output will change.
## References
