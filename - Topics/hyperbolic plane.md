...
- the cosine rule states that$$\cosh a = \cosh b \cosh c - \sinh b \sinh c \cos \alpha,$$with similar versions for $\beta$ and $\gamma$, and the dual cosine rule states that$$\cos \alpha = - \cos \beta \cos \gamma + \sin \beta \sin \gamma \cosh a.$$
