## Synthesis
- In supervised learning, classification predicts discrete, categorical classes or labels
	- By discrete classes, we mean that the output belongs to a finite set of categories. For example:
		- Predicting if an email is "spam" or "not spam"
		- Classifying an image as "cat", "dog", or "bird"
	- #question Could you give an example? 
	- #question What is supervised learning?
	- #question Is there a difference between classes, labels, or features?
## Source [^1]
...
## Source[^2]
- In supervised learning, cllassification predicts discrete classes
	- #comment 
		- Examples
			- Predicting an e-mail is spam or not spam
			- Identifying an image to be a cat, dog or other animal 
## References

[^1]: [[(Home Page) A Dictionary of Biology 8th Edition by Oxford Reference]]
[^2]: [[(Home Page) 500+ Machine Learning and Artificial Intelligence Interview Questions and Answers by Applyre]]