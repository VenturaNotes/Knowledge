...
- 
## Source [^1]
- A method of production where output emerges in discrete quantities. It is often used when there is a requirement that a certain quantity of a product should be of a uniform pattern and quality, but the required characteristics differ between different orders.
## Source[^2]
