...
## Source[^2]
- The determination of the relationship between the indicated value on a measuring instrument and the true value of the being measured. This may result in the adjustment – or calibration – of the measuring instrument to a set value against a reference input. The true value is the value that would be obtained if all sources of error were eliminated.
## References
