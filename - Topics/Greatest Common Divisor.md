...
## Synthesis
### Description
- The GCD of two or more non-zero integers is the largest positive integer that divides each of the integers without leaving a remainder.
### Example
- To find `gcd(12,18)`
	- List divisors of 12
		- `1, 2, 3, 4, 6, 12`
	...
	- Identify common divisors
		- `1, 2, 3, 6`
	- Find greatest among the common divisors
		- `6`
	- Therefore, the greatest common divisor of 12 and 18 is `6`
## Source[^1]
### Definition
