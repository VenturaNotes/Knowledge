---
Source:
  - zotero://open-pdf/library/items/PBUU3ZVE?page=4&annotation=5NZ6VHSE
Length: "1493"
Progress: "0"
tags:
  - status/incomplete
...
- Unit 2 - The Cell
	- “Art has been added to Figure 6.17 to illustrate the dynamic nature of [[mitochondrial networks]].” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=IMXLMR4E))
	- “Chapter 7 begins with a new chapter-opening image showing [[neurotransmitter]] release during [[exocytosis]].” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=ATE3SLUK))
	- “Chapter 9 includes new information on human [[brown fat]] usage, the role of [[fermentation]] during the production of chocolate, and recent research on the role of [[lactate]] in mammalian [[metabolism]].” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=ULABXFN8)
	- “Chapter 10 begins with a new concept that puts [[photosynthesis]] into a big-picture ecological context.” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=BH97WY5R))
	- “Chapter 10 also includes a discussion of the 2018 discovery of a new form of [[Chlorophyll]] found in [[cyanobacteria]] that can carry out photosynthesis using far-red light” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=B4DL7W6R))
	- “Chapter 11, the relevance of [[synaptic signaling]] is underscored by mentioning that it is a target for treatment of depression, anxiety, and PTSD.” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=9I7QEG8L))
	- “In Chapter 12, the [[cell cycle]] figure (Figure 12.6) now includes cell images and labels describing the events of each phase.” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=9PL9WYX3))
- Unit 3 - Genetics
	- “In Chapter 14, the classic idea of a single gene determining hair or eye color, or even earlobe attachment, is discussed as an oversimplification.” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=XNVDJGCJ))
	- “Also, the “Fetal Testing” section has been updated to reflect current practices in obstetrics.” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=SNSPMLAR))
	- “Chapter 15 now includes new information on [[three-parent baby|“three-parent” babies]].” ([Urry et al., 2020, p. 18](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=21&annotation=XGS7ZQCX))
	...
	- “updates include results of the[[ Cancer Genome Atlas Project]], a newly discovered function of [[retrotransposon transcription]], and new information on the [[FOXP2 gene]].” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=SUG84D7G))
- Unit 4 - Mechanisms of Evolution
	- “[[hybrids]] can become [[reproductively isolated]] from both parent species, leading to the formation of a new [[species]].” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=A9HTFXYV))
		- “2018 study on the descendants of hybrids between two species of Galápagos finches” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=THCZBRJI))
	- “highlights five different types of fossils and how they are formed.” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=Q4E867SX))
	- “some snowshoe hare populations have not adapted to ongoing climate change, causing them to be poorly camouflaged in early winter and leading to increased mortality.” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=XZBITCUB))
	- “provides fossil evidence of an enormous change in the evolutionary history of life: the first appearance of large, [[multicellular eukaryotes]].” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=YR57S63W))
- Unit 5 - The Evolutionary History of Biological Diversity
	- “New Visual Skills Questions provide practice on topics such as interpreting [[phylogenetic trees]] and using graphs to infer how rapidly [[antibiotic resistance]] evolves in bacteria.” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=BIV46AMI))
	- “[[Neanderthals]] and [[Denisovans]] are more closely related to each other than to [[humans]] and that they interbred with each other (and with humans)” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=VH92G7M4))
	- “Chapter 27 includes a new section of text that describes the rise of [[antibiotic resistance]] and [[multidrug resistance]] and discusses novel approaches in the search for new antibiotics.” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=6CA7DWI6))
	- “text describing the 2017 discovery of 315,000-year-old fossils of a [[hominin]] that had facial features like those of [[humans]], while the back of its skull was elongated, as in earlier species.” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=T6ZBSZVI))
- Unit 6 - Plant Form and Function
	- “greater emphasis is placed on how structure fits function in [[vascular plants]]” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=U2VDZ5UU))
	- “quantitative exercise in estimating [[stomatal density]].” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=EGSZUDIJ))
	- “importance of [[crop fertilization]] in feeding the world.” ([Urry et al., 2020, p. 19](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=22&annotation=QLUA99ZT))
	- “expanded to include [[micronutrients]] as well as [[macronutrients]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=7S6P29ZA))
	- “new evidence that [[global climate change]] may be negatively impacting the nutritional mineral content of crops.” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=KZRDW8IM))
	- “discussion of [[genetic engineering]] and [[agriculture]] has been enhanced by a discussion of [[biofortification]] and by updates concerning “[[Golden Rice]].”” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=99HJ6IIK))
	- “location of the[[ IAA receptor]] in [[plant cells]] and the role of [[abscisic acid]] in [[bud dormancy]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=RVKAR8L3))
	- “[[Plants]] use many classes of chemicals in addition to the classic hormones to communicate information” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=CU4DZR59))
- Unit 7 - Animal Form and Function
	- “A striking new underwater image of Emperor penguins (Figure 40.1) opens the unit and highlights the contributions of [[Form|form]], [[Function (Biology)|function]], and [[Behavior|behavior]] to [[homeostasis]] in general as well as to the specific topic of [[thermoregulation]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=5QV5PD7A))
	- “role of [[perturbation]] in triggering a response” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=PMWDUKQF))
	- “introduction of the [[adaptive immune response]] has been shifted to later in the chapter, allowing students to build on the features of [[innate immunity]] before tackling the more demanding topic of the [[adaptive response]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=CY92J932))
	- “structural overview of [[neurons]] is now completed before the introduction of [[Information Processing (Biology)|information processing]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=RCJVGFW5))
	- “provides a concise visual comparison of [[sympathetic neurons]] and [[parasympathetic neurons]] with each other and with [[motor neurons]] of the [[CNS]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=LZBAVF3M))
	- “in-depth consideration of [[glia]] is now provided” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=TEXRVZG5))
		- “it is more logically integrated into the overview of [[nervous systems]].” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=CIE8ZKKI))
	- “[[phage therapy]] and [[fecal transplantation]], state-of-the-art treatments that both rely on microbiome data, and [[chronic traumatic encephalopathy]] (CTE), as well as the latest findings on [[dinosaur locomotion]] (Concept 40.1), the awarding of a Nobel Prize in 2017 in the field of [[circadian rhythms]] (Concept 40.2), and reference to the ongoing public health crisis of [[opioid addiction]] in the context of considering the [[brain’s reward system]]” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=RE9V36VN))
- Unit 8 - [[Ecology]]
	- “how plants (and [[deforestation]]) can affect the [[local climate]] or [[regional climate]]” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=6Z7I8ZNU))
	- “summarizes how [[ecosystem|ecosystems]] work” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=QVKJ5I54))
	- “rapid [[evolution]] can cause rapid ecological change” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=SK7HSUZS))
	...
	- “describes how [[global climate change]] models are developed and why they are valuable.” ([Urry et al., 2020, p. 20](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=23&annotation=4GUZUEMG))

## (1) Evolution, the Themes of Biology, and Scientific Inquiry
- ![[Screenshot 2023-06-03 at 9.01.54 AM.png|500]]
	- As a result of [[evolution]] through [[natural selection]], the fur colors of these two [[Population (Biology)|populations]] of mice ([[beach mouse]] and [[inland mouse]]) resemble their surroundings, providing protection from [[predators]]
		- Beach mouse has a light color which blends into its [[habitat]] $\textemdash$ white sand dunes of Florida seashore
		- Inland mouse is darker and blends better with soil and vegetation
- ![[Screenshot 2023-06-03 at 1.49.34 PM.png]]
	- [[Structure]] fits [[Function (Biology)|function]] at all levels of a mouse's [[organization]]
		- Organ (heart)
			- Tissue
				- Cell
					- Molecule
	- [[Genetic information]] encoded in [[DNA]] determine's a mouse's fur colors.
		- [[Gene]] for brown fur
		- Gene for white fur
	- “[[Energy]] flows one way from the sun to plants to a mouse; [[matter]] cycles between a mouse and its environment.” ([Urry et al., 2020, p. 48](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=51&annotation=9ZFYX6XB))
	- “A plant being eaten by a mouse and a mouse being preyed upon by a hawk are [[interactions]] within a system.” ([Urry et al., 2020, p. 48](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=51&annotation=HAUWHRNU))

### (Concept 1.1) The Study of Life Reveals Unifying Themes
- ![[Screenshot 2023-06-03 at 2.06.41 PM.png]]
	- Some [[Properties of Life]]
		- [[Order]]
			- <mark style="background: #FFF3A3A6;">Example</mark>: A close-up of a sunflower illustrates the highly ordered structure that characterizes life
		...
		- [[Growth and development]]: 
			- <mark style="background: #FFF3A3A6;">Example</mark>: “Inherited information carried by genes controls the pattern of growth and development of organisms, such as this oak seedling.” ([Urry et al., 2020, p. 49](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=52&annotation=CZ3YDXJP))
		- [[Response to the environment]]: 
			- <mark style="background: #FFF3A3A6;">Example</mark>:“The Venus flytrap on the left closed its trap rapidly in response to the environmental stimulus of a grasshopper landing on the open trap.” ([Urry et al., 2020, p. 49](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=52&annotation=ZDVPPI6P))
		- [[Reproduction]]: 
			- <mark style="background: #FFF3A3A6;">Example</mark>: “Organisms (living things) reproduce their own kind.” ([Urry et al., 2020, p. 49](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=52&annotation=95XS5P4V))
...
- (1) [[Biosphere]]
	- “consists of all life on Earth and all the places where life exists: most regions of land, most bodies of water, the atmosphere to an altitude of several kilometers, and even sediments far below the ocean floor.” ([Urry et al., 2020, p. 50](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=53&annotation=2YBPAU2T))
- (2) [[Ecosystems]] ^uq0c6m
	- “consists of all the living things in a particular area, along with all the nonliving components of the environment with which life interacts, such as soil, water, atmospheric gases, and light.” ([Urry et al., 2020, p. 50](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=53&annotation=5JTK8AIZ))
	- Examples include tropical forest, grassland, desert, and coral reef
- (3) [[Communities]]
	- “array of organisms inhabiting a particular ecosystem” ([Urry et al., 2020, p. 50](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=53&annotation=SDUAF79T))
...
- (5) [[Organisms]]
	- “Individual living things” ([Urry et al., 2020, p. 50](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=53&annotation=6VR3GRJG))
	- “Each plant in the meadow is an organism, and so is each animal, fungus, and bacterium.” ([Urry et al., 2020, p. 50](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=53&annotation=F6BL4IJA))
- (6) [[Organs]] ^8etwza
	- “a body part that is made up of multiple tissues and has specific functions in the body.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=QXYP5U38))
	- “Leaves, stems, and roots are the major organs of plants” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=TEI6FDMB))
	- “Within an organ, each [[Tissue|tissue]] has a distinct arrangement and contributes particular properties to organ function.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=JJLM7A42))
- (7) [[Tissues]] ^29ihpf
	- “Viewing the tissues of a leaf requires a microscope.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=N8QYRR8Z))
...
- (8) [[Cells]] ^ikngtm
	...
	- “magnified view of a cell in a leaf tissue.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=ET2MZP6P))
		- “cell is about 40 micrometers (μm) across—about 500 of them would reach across a small coin.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=PIQYEGQU))
	- “Within these tiny cells are even smaller green structures called [[Chloroplast|chloroplasts]], which are responsible for photosynthesis.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=UM3M5JDN)) ^50okav
- (9) [[Organelle|Organelles]]
...
- (10) [[Molecules]]
	...
	- “[[Chlorophyll]] is the pigment that makes a leaf green” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=YPH5S8NU))
...
- “[[emergent properties]] are due to the arrangement and interactions of parts as complexity increases.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=TATCRS6N))
	...
	- “coordinated processes of photosynthesis require a specific organization of these molecules in the chloroplast” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=ED4RSIYW))
	- “Isolated components of living systems $\textemdash$ the objects of study in a [[reductionist approach]]— lack a number of significant properties that emerge at higher levels of organization.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=G8HFM5JZ)) ^gcpovg
- “<mark style="background: #FFF3A3A6;">To fully explore emergent properties</mark>, biologists today <mark style="background: #FFF3A3A6;">complement reductionism with</mark> [[Systems Biology|systems biology]], the exploration of a biological system by analyzing the interactions among its parts.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=VDQ9FYTL))
	- “a single leaf cell can be considered a system, as can a frog, an ant colony, or a desert ecosystem.” ([Urry et al., 2020, p. 51](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=54&annotation=4C4JFL8C))
	- Systems biology can be used to study life at all levels ^ldvqa9
		- Including networks of molecular interactions affecting our 24-hour cycle and how atmospheric carbon dioxide laters ecosystems and the entire biosphere.
...
- “The [[cell]] is the smallest unit of organization that can perform all activities required for life.” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=VKJA3TGS))
- “[[Cell Theory]] was first developed in the 1800s” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=CYZFGGFI))
	- “theory states that all living organisms are made of cells, which are the basic unit of life.” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=MAL6KIXA))
	- Examples
		- Reading (activities of muscle and nerve cells)
		- Recycling of carbon atoms (product of cellular functions) including photosynthetic activity of [[Chloroplast|chloroplasts]] in leaf cells
- “every cell is enclosed by a membrane that regulates the passage of materials between the cell and its surroundings.” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=9IC7SBPM))
- Two main forms of cells
	- [[prokaryotic]]
		- “Prokaryotic cells are found in two groups of single-celled microorganisms, [[bacteria]] (singular, bacterium) and [[archaea]] (singular, archaean)” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=2L834KB8)) ^z11lt5
	- [[eukaryotic]]
		- “All other forms of life, including plants and animals, are composed of eukaryotic cells.” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=2VGZD99Z))
- ![[Screenshot 2023-08-15 at 3.56.20 PM.png]]
	- Parts shown
		- Eukaryotic cell
			- [[Membrane]]
			- [[Cytoplasm]]
		...
		- [[Prokaryotic cell]]
			- DNA (no nucleus)
			- Membrane
	- “A [[eukaryotic cell]] contains membrane-enclosed organelles (Figure 1.4).” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=VNECVVWY))
- “Some organelles, such as the DNA-containing nucleus, are found in the cells of all eukaryotes; other organelles are specific to particular cell types.” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=XV8XRWG2))
	- [[Chloroplast|Chloroplasts]] found only in eukaryotic cells that carry out photosynthesis
- “a [[prokaryotic cell]] lacks a nucleus or other membrane-enclosed organelles” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=H2Q4A3JK))
	- “prokaryotic cells are generally smaller than eukaryotic cells,” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=2DWC8AT5))


#### Theme: Life's Processes Involve the Expression and Transmission of genetic Information
- “Within cells, structures called [[chromosome|chromosomes]] contain genetic material in the form of [[DNA]] (deoxyribonucleic acid).” ([Urry et al., 2020, p. 52](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=55&annotation=RPUECJHY))
	- ![[Screenshot 2023-08-15 at 4.01.52 PM.png|500]]
		- In cells preparing to divide, chromosomes may be made visible using a dye that appears blue when bound to the DNA
...
- ![[Screenshot 2023-08-15 at 4.08.04 PM.png|400]]
	- Process
		...
		- (3) [[Embryo]]'s cells with copies of inherited DNA
		- (4) [[Offspring]] with traits inherited from both parents
	- “You began as a single cell stocked with DNA inherited from your parents.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=6RAFZXZJ))
	- “The replication of that DNA prior to each cell division transmitted copies of the DNA to what eventually became the trillions of cells of your body.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=MUNW7GGS))
	- “As the cells grew and divided, the genetic information encoded by the DNA directed your development” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=TIQAMBSY))
- ![[Screenshot 2023-08-15 at 4.21.05 PM.png]]
	- Description
		- Given a cell, you have the nucleus and DNA
		- DNA double helix
			- Made up of two long chains ([[strands]]) of building blocks called nucleotides, a DNA molecule takes the three-dimensional form of a double helix
		- Single Strand of DNA
			- Genetic information is encoded in specific sequences of the four types of nucleotides (A, T, C, and G) are the name abbreviated
	- “molecular structure of [[DNA]] accounts for its ability to store information.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=CVQZCR6H))
	- “[[DNA]] molecule is made up of two long chains, called strands, arranged in a double helix.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=VGS5IIX2))
	- “Each chain is made up of four kinds of chemical building blocks called [[Nucleotide|nucleotides]], abbreviated A, T, C, and G” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=Z7Y47689)) ^99zpja
- “For many genes, the sequence provides the blueprint for making a protein.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=GEXN4FTY))
	- “a given bacterial gene may specify a particular protein (such as an [[enzyme]]) required to break down a certain sugar molecule, while one particular human gene may denote an enzyme, and another gene a different protein (an [[antibody]], perhaps) that helps fight off infection.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=N9CMHQMX))
	- “[[proteins]] are major players in building and maintaining the cell and carrying out its activities.” ([Urry et al., 2020, p. 53](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=56&annotation=CK3FENLY))
- ![[Screenshot 2023-08-15 at 4.58.25 PM.png]]
	- Description
		- [[Gene expression]]: Cells use information encoded in a gene to synthesize a functional protein
		- (a) The [[lens]] of eye (behind pupil) can focus on light because lens have transparent proteins called [[crystallin]]
		- (b) Lens cell uses information in DNA to make [[Crystallin Protein|crystallin proteins]]
			- (1) [[Crystallin gene]] is a section of DNA in a chromosome
			- (2) You have DNA that's part of the crystallin gene
			- (3) [[Transcription]]
				- Using information in sequence of DNA nucleotides, cell makes (transcribes) a specific [[RNA]] molecule called [[mRNA]]
			- (4) With mRNA
			- (5) [[Translation]]
				- Cell translates information in the sequence of mRNA nucleotides to make a [[protein]], a series of linked amino acids
			- (6) With a Chain of amino acids
			- (7) [[Protein Folding]]
				- Chain of amino acids folds into the specific shape of a [[crystallin protein]]
					- Crystallin proteins pack together and focus light allowing eye to see
	- “[[Protein-encoding genes]] control protein production indirectly, using a related molecule called [[RNA]] as an intermediary.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=WRBMIZF2))
		- “sequence of [[Nucleotide|nucleotides]] along a gene is transcribed into [[mRNA]], which is then translated into a linked series of protein building blocks called [[Amino Acid|amino acids]]” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=HB7B75SW))
		- “the amino acid chain forms a specific protein with a unique shape and function.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=T9SSNK4L))
		- “entire process by which the information in a gene directs the manufacture of a cellular product is called [[gene expression]]” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=DJ73JJKB))
- “In carrying out [[gene expression]], all forms of life employ essentially the same [[genetic code]]: A particular sequence of nucleotides means the same thing in one organism as it does in another.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=IIJFRC9S))
	- “Differences between organisms reflect differences between their [[Nucleotide Sequence|nucleotide sequences]] rather than between their [[Genetic Code|genetic codes]].” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=HSYRXQY3))
	- “universality of the genetic code is a strong piece of evidence that all life is related.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=I2358FVJ))
		- Comparing sequences in several species for a gene that codes a particular protein is valuable information about the protein and relationship between species
- “Molecules of [[mRNA]], like the one in Figure 1.8, are translated into proteins, but other [[cellular RNAs]] function differently” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=EYH535YD))
- “some types of [[RNA]] are actually components of the cellular machinery that manufactures proteins.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=GMUYGG2T))
	- “new classes of RNA that play other roles in the cell, such as regulating the function of protein-coding genes.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=TY7CNWLZ))
	- “[[Gene|Genes]] specify these [[RNA|RNAs]] as well, and their production is also referred to as [[gene expression]].” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=IXWDB7P6))
- “By carrying the instructions for making proteins and RNAs and by replicating with each cell division, DNA” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=7EXQIJZ6))

##### Genomics: Large-Scale Analysis of DNA sequences
- “The entire “library” of genetic instructions that an organism inherits is called its [[genome]].” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=EMA5HTEM))
	- “typical human cell has two similar sets of [[chromosome|chromosomes]], and each set has approximately 3 billion [[nucleotide pairs]] of DNA.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=9VQJVQS9))
- “The [[genome sequence]]—the entire sequence of nucleotides for a representative member of a species—is now known for humans and many other animals, as well as numerous plants, fungi, bacteria, and archaea.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=3IKACP7T))
- “the growing catalog of known gene functions, scientists are applying a [[systems biology approach]] at the cellular and molecular levels.” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=KUVLVW4A))
	- “Rather than investigating a single gene at a time, researchers study whole sets of genes (or other DNA) in one or more species—an approach called [[genomics]].” ([Urry et al., 2020, p. 54](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=57&annotation=KKYLAIX3))
	- “the term [[proteomics]] refers to the study of sets of proteins and their properties” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=EDJ8IWM2))
		- “(The entire set of proteins expressed by a given cell, tissue, or organism is called a [[proteome]].)” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=425CLZQF))
- 3 important developments of genomic and proteomic approaches
	- “One is [[high throughput technology|"high-throughput" technology]], tools that can analyze many biological samples very rapidly.” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=2V65D5NN))
	- “[[bioinformatics]], the use of computational tools to store, organize, and analyze the huge volume of data that results from high-throughput methods” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=BHGAQ826))
	- “formation of interdisciplinary research teams—groups of diverse specialists that may include computer scientists, mathematicians, engineers, chemists, physicists, and, of course, biologists from a variety of fields.” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=2KCWDP6G))
		- “aim to learn how the activities of all the proteins and RNAs encoded by the DNA are coordinated in cells and in whole organisms” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=8D6FTDML))
#### Theme: Life Requires the Transfer and Transformation of Energy and Matter
- ![[Screenshot 2023-08-16 at 3.22.01 PM.png]]
	- Description
		- [[Energy flow]] and [[chemical cycling]]
			- One-way flow of energy in an [[ecosystem]]
				- During [[photosynthesis]], plants convert energy from sunlight to [[chemical energy]] (stored in food molecules such as sugars), which is used by 
				  [[plants]] and other organisms to do work and is eventually lost from the [[ecosystem]] as heat.
			- Contrasting, chemicals cycle between [[organisms]] and the [[physical environment]]
		- Energy Flow
			- (1) Light energy comes from the sun
			- (2) Plants convert sunlight to chemical energy
			- (3) Organisms use chemical energy to do work
			- (4) Heat is lost from the ecosystem
		- Chemical cycling
			- Chemicals in plants are passed to organisms that eat the plants
			- [[Decomposer|Decomposers]] such as fungi and bacteria break down leaf litter and dead organisms, returning chemicals to the soil
...
- “When an organism uses chemical energy to perform [[work]], such as muscle contraction or cell division, some of that energy is lost to the surroundings as [[heat]].” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=BLB4R6DZ))
	- “[[energy]] flows through an ecosystem in one direction, usually entering as light and exiting as heat.” ([Urry et al., 2020, p. 55](zotero://select/library/items/DJ2VRK6E)) ([pdf](zotero://open-pdf/library/items/PBUU3ZVE?page=58&annotation=WVNAZFXW))
