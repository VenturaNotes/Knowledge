...
- All Numbers ($\frac 47$, 3, 0, -5, 1.5, $\pi$, $\sqrt 2$, $i$, 4 + 5$i$)
	...
	- Real ($\frac 47$, 3, 0, -5, 1.5, $\pi$, $\sqrt 2$ )
		...
		- Rational (3, 0, -5, 1.5, $\frac 47$)
			- Non-integers (1.5, $\frac 47$ )
			- Integers (3, 0, -5)
				- Negative Integers (-5)
				- Whole Numbers (3, 0) (aka nonnegative integers) ^14aad5
					- Zero (0)
					- Natural Numbers (Positive Integers) (3)

## References

[^1]: https://byjus.com/maths/complex-numbers/