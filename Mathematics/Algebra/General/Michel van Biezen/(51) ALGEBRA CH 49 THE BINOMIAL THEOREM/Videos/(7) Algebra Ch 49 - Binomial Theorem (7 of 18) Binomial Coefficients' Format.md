...
- ![[Screenshot 2023-05-03 at 2.51.49 AM.png]]
	...
	- "n" will always be bigger or equal to "m"
		- Top number is the same as the exponent in the binomial expansion
		- Bottom number indicates exponent of the second term in the binomial expansion
		- Looking for numerical coefficient which we'll get when we expand it out the way it's written.