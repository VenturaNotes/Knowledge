...
- ![[Screenshot 2023-04-02 at 11.18.47 PM.png]]
	...
	- (2) Find the intersection of plane EFG and plane EAB
		- A plane is defined by 3 points that are not collinear (not on the same line)
	- (3) Which points are collinear with F?
	- (4) Which points are coplanar with plane HGC?