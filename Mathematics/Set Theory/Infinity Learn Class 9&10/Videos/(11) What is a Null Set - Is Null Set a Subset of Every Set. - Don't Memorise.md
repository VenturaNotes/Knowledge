...
- ![[Screenshot 2023-03-30 at 1.48.23 PM.png]]
	...
	- Sensory organs of book (ears, eyes...) are nonexistent which means this scenario would represent an empty set.
		- For humans, it would be {Ears, Eyes, Nose...
	- Null set is a subset of every set
		- Null set is a subset of the null set as well
	- When thinking of a set such as A = {1, 2, 3}, we can say it has the elements 1, 2, 3 and nothing