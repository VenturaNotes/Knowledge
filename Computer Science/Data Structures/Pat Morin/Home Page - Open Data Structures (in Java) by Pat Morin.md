...
- “To create a dictionary/map, one forms compound objects called [[Pairs]], each of which contains a <mark style="background: #FFF3A3A6;">key</mark> and a <mark style="background: #FFF3A3A6;">value</mark>.” ([Morin, p. 8](zotero://select/library/items/AZMT4QS6)) ([pdf](zotero://open-pdf/library/items/UCIXKDGW?page=20&annotation=ZTPMZGXN))
