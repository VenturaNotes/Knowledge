...
- In digital signals, we discretize both time and magnitude
	- By discretization, we need to divide the time axis in equal intervals
		- If $\triangle t$ is the interval, then we can find it with
			- ![[Screenshot 2022-12-22 at 11.37.08 AM.png]]
				- This is how we can find the interval
- We divide the magnitude axis in to fixed number of levels and the signal can take value equal to these levels only
