...
<html>
  ...
  <body>
    ...
    <button id="multiplierButton" onclick="calculateMultiplier()">Adjust Speed</button>
    <button id="startButton" onclick="showStartTime()">Start</button>
    <button id="storeButton" onclick="storeTime()">Pause</button>
...
```
#### Description
- Removed Reward and Time Based estimate
- Removed dependency for "Main" page
- Sidebar.html is same as solution 10
## Version 1
### Attempt #1
#### Sidebar.html
