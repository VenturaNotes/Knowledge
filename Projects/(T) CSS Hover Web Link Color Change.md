...
### Suggestion from Kepano [^1]
- CEO of Obsidian starting February 2023. 
	- Created popular themes (Minimal) and plugins (Hider, Web Clipper)
- ![[A-way-to-differentiate-between-internal-and-external-links-r-ObsidianMD.png]]
	- He suggests to adjust variables directly. I'm not sure if they work during live preview in the footnote section, but will try to optimize my solution later
	- At least my current CSS snippet should have backwards compatibility within Obsidian
### Solution
```css
...
[^1]: https://www.reddit.com/r/ObsidianMD/comments/1s8tkxx/comment/odjf8uq/?solution=ca7da6662cfb1935ca7da6662cfb1935&js_challenge=1&token=bbbe4bf1c9a2b5160829c4be34da5861a3a2b6b90016314217b49106f111c51b&context=1
