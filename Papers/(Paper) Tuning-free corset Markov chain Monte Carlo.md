...
## Abstract
- [[Bayesian coreset]]
	- Small, weighted subset of a data set that replaces the full data during inference to reduce computational cost
		- #question What is meant by inference?
		- #question Difference between bayesian coreset and coreset?
